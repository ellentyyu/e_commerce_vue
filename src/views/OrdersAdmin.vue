<template>
  <div class="admin-orders admin-table pt-4 pb-5" style="margin-left:-12px; margin-right:-12px">
    ...
    <div class="d-flex flex-column h-100">
      <table class="table mb-auto">
        ...
        <tbody>
          <tr v-for="item in orders" :key="item.id">
            ...
            <td>
              <div class="btn-group">
                <button class="btn btn-outline-success btn-sm" @click="openModal(item)">編輯</button>
      ...
      <Pagination class="mt-4" :pages="pagination" @emit-pages="getOrders"></Pagination>
    </div>
    <OrderModal ref="orderModal" :order="tempOrder" @update-order="updateOrder"></OrderModal>
    <DelModal ref="delModal" :delItem="delOrder" @delete-item="deleteOrder"></DelModal>
