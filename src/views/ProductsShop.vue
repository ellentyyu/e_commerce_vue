<template>
  ...
  <Loading :active="!products.length"></Loading>
  <Layout ref="layout">
    <div class="container-fluid container-custom pt-9 pb-7">
      ...
      <Pagination class="mt-5" v-if="pagination.total_pages" :pages="pagination" @emit-pages="switchPage"></Pagination>
    </div>
  </Layout>
  <ScrollTop></ScrollTop>
</template>
  ...
  computed: {
    ...
    pagination() {
      ...
      if(this.filteredProducts.length > 0) {
        if((this.filteredProducts.length / 9).isInteger) {
