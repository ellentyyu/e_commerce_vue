...
<div :class="{'overflow-hidden':isShow,'vh-100':isShow}">
      ...
      <div class="container-fluid navbar-p">
        ...
        <div class="collapse navbar-collapse order-4 order-lg-3" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link px-3" href="#/help">
        ...
        <ul class="d-flex align-items-center order-3 orger-lg-4">
          <li class="d-none d-md-block">
            <div class="search-wrap">
              ...
              <input type="text" class="search-input" :class="{'show':isSearch}" placeholder="商品名稱">
        ...
        <template v-if="cart.final_total !== 0">
          ...
          <div class="cart-footer px-4 pt-4 pb-5">
            ...
            <div class="text-center ls-1">
              ...
              <button class="btn btn-custom-transparent ls-1" :class="{'disabled':isDelAll}" @click="delCartAll">清空購物車
  ...
  <footer class="container-fluid container-custom pt-5 pb-6 text-center footer">
    ...
    <ul class="row justify-content-center px-4 px-sm-0">
      <li class="col-6 col-sm-auto"><a href="#/shop/products" class="footer-link px-sm-3 pt-3 pb-2">
              <span class="link-underline">商店逛逛</span>
          </a>
      </li>
      <li class="col-6 col-sm-auto"><a href="#" class="footer-link px-sm-3 pt-3 pb-2">
      ...
      <li class="col-6 col-sm-auto"><a href="#/admin/products" class="footer-link px-sm-3 pt-3 pb-2">
          <span class="link-underline">後台登入</span></a></li>
    </ul>
    <p class="fs-s text-fade">Solljus © 2022 COPYRIGHT</p>
    <ul class="d-flex justify-content-center">
      <li><a href="#" class="fs-3 p-3 media-icon fab fa-facebook-f"></a></li>
      <li><a href="#" class="fs-3 p-3 media-icon fab fa-instagram"></a></li>
      <li><a href="#" class="fs-3 p-3 media-icon far fa-envelope"></a></li>
    </ul>
  </footer>
</div>
</template>
